...
Seleziona l'utente per il quale vuoi esprimere un giudizio :<br />
Ricerca : <input type="text" />
	<table class="tabelle_form">
	<tr>
	<td>Nome</td><td>Cognome</td><td>Codice Fiscale</td><td>Giudizio</td>
	</tr>
	<tr>
	<td>Nome</td><td>Cognome</td><td>Codice Fiscale</td><td><input type="button" value="Inserisci Giudizio" /></td>
	</tr>
