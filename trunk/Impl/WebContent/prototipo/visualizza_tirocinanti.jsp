...
Elenco dei tirocinanti<br />
Ricerca : <input type="text" />
	<table class="">
	<tr>
	<td>Nome</td><td>Cognome</td><td>Codice Fiscale</td><td>Mostra Scheda</td>
	</tr>
	
	<tr>
	<td>NOME</td><td>COGNOME</td><td>CODICE FISCALE</td><td><input type="button" value="Mostra" /></td>
	</tr>
