...
Elenco delle richieste da approvare
	...
	<tr>
	<td>Nome</td><td>Cognome</td><td>Codice Fiscale</td><td>Approva</td><td>Cancella</td>
	</tr>
	
	<tr>
	<td>NOME</td><td>COGNOME</td><td>CODICE FISCALE</td><td><input type="submit" value="Approva" /></td><td><input type="submit" value="Cancella" /></td>
	</tr>
