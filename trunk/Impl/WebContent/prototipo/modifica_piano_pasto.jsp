...
Seleziona il piano pasto da modificare:<br />
Ricerca : <input type="text" /><br />

	<table class">
	<tr> 
	<td>Nome</td><td>Cognome</td><td>Codice Fiscale</td><td>Piano Pasto Attuale</td><td>Modifica</td>
	</tr>
	
	<tr>
	<td>NOME</td><td>COGNOME</td><td>CODICE FISCALE</td><td>Classico</td><td><input type="submit" value="Modifica" /></td>
	</tr>
	
	<tr>
	<td>NOME</td><td>COGNOME</td><td>CODICE FISCALE</td><td>Vegetariano</td><td><input type="submit" value="Modifica" /></td>
	</tr>
