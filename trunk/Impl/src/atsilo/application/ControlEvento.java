...
/*
 * ====EVENTO=== Evento avrà i seguenti attributi
 * 
 * -- -Nome -Descrizione -Data -Tipo -CC
 * 
 * Il tipo è una stringa e può essere: Evento organizzato, Riunione I CC è una
...
public class ControlEvento {
     ...
     * 
     * @param cc
     *            è una stringa che contiene le email separate da virgola
     * @return una lista di utenti in cui è settato solo il campo per l'email
     */
