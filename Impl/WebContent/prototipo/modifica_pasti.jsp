...
<%@
include file="siderbar_genitore.jsp"
 %>
...
Inserisci il tipo di menu che preferisci <br />

<form action="" method="post">
<table class="tabella_form">
	<tr>
	<td>Tipo Menu</td><td><input type="text" name="menu"/></td>
	</tr>
	<tr>
	<td>Allega Certificato Medico</td><td><input type="file" value="certificato"/></td>
	</tr>
</table>
<br />
