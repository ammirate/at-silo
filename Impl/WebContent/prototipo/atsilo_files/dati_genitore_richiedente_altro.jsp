...
<table border="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><textarea name="rappori_ateneo" id="rappori_ateneo" cols="45" rows="5"></textarea></td>
  </tr>
  <tr>
    <td colspan="2">Motivare i rapporti con il Comune Di Fisciano</td>
    <td colspan="3"><textarea name="rappori_comune" id="rappori_comune" cols="45" rows="5"></textarea></td>
  </tr>
    <tr>
    <td>&nbsp;</td>
    <td colspan="3">&nbsp;</td>
