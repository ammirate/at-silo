...
<table class="">
	<tr>
	<td>Nome</td><td><td>Cognome</td><td><td>Codice Fiscale</td><td><td>Modifica</td><td>
	</tr>
	<tr>
	<td>NOME</td><td><td>COGNOME</td><td><td>CODFISC</td><td><td><input type="button" value="MODIFICA" /></td><td>
	</tr>
...
<form action="" method="post">
	...
	<tr>
	<td>Ore Totali</td><td><input type="text"/></td>
	</tr>	
	<tr>
	<td>Stato</td><td><input type="text"/></td>
	</tr>
	</table>
