 ...
 <%
 	if  (request.getParameter("successo") != null && !temp_nome_chiamante.equals("presenta_iscrizione.jsp") ) { 
 		if (request.getParameter("successo").equals("ok")) {
 			out.print("<script type=text/javascript>alert('Presentazione domanda effettuata con successo. � necessario consegnare i documenti all'asilo: Liberatoria sulla privacy, certificati vaccinazioni, certificati malattie infettive contratte.')</script>");
 		} else {
